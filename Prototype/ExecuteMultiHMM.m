...
fprintf('Directory created: HMMSoundFiles');

% First File
fileID = fopen('HMMSoundFiles/SoundFile.phn_1','w');
...
fileID = fopen('HMMSoundFiles/SoundFile.phn_2','w');
...
fileID = fopen('HMMSoundFiles/SoundFile.phn_3','w');
fprintf(fileID, '9000 10000 sh\n');
